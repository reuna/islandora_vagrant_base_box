...
# Clone REUNA/Biodiversidad modules
cd "$DRUPAL_HOME"/sites/all/modules
git clone https://github.com/reuna/islandora_solution_pack_ontologies-7.x-dev
git clone https://github.com/reuna/islandora_solution_pack_redbiodiversidad-7.x-dev

cd "$DRUPAL_HOME"/sites/all/modules/islandora_solution_pack_ontologies-7.x-dev
git config core.filemode false
cd "$DRUPAL_HOME"/sites/all/modules/islandora_solution_pack_redbiodiversidad-7.x-dev
git config core.filemode false
...
# Move Ontologies Solution Pack drush file to user's .drush folder
if [ -d "$HOME_DIR/.drush" -a -f "$DRUPAL_HOME/sites/all/modules/islandora_solution_pack_ontologies-7.x-dev/islandora_solution_pack_ontologies-7.x-dev.drush.inc" ]; then
  mv "$DRUPAL_HOME/sites/all/modules/islandora_solution_pack_ontologies-7.x-dev/islandora_solution_pack_ontologies-7.x-dev.drush.inc" "$HOME_DIR/.drush"
fi

# Move Biodiversidad Solution Pack drush file to user's .drush folder
if [ -d "$HOME_DIR/.drush" -a -f "$DRUPAL_HOME/sites/all/modules/islandora_solution_pack_redbiodiversidad-7.x-dev/islandora_solution_pack_redbiodiversidad-7.x-dev.drush.inc" ]; then
  mv "$DRUPAL_HOME/sites/all/modules/islandora_solution_pack_redbiodiversidad-7.x-dev/islandora_solution_pack_redbiodiversidad-7.x-dev.drush.inc" "$HOME_DIR/.drush"
fi
...
drush -y -u 1 en islandora_solution_pack_redbiodiversidad-7.x-dev islandora_solution_pack_ontologies-7.x-dev
